...
use crate::core::network::protocol::play::serverbound::{register_play_packet, PlayPacketWriters};
use crate::core::player::interact::SentInteract;
use crate::core::player::inventory::{Inventory, InventoryState};
use crate::core::player::known_state::KnownState;
use crate::core::player::{Player, PlayerJoinEvent, PlayerPacketBuffer, PlayerSkin, Username, Uuid};
use bevy::app::Last;
...
pub struct PlayerEntityLookup(SecondaryMap<ClientId, Entity>);
...
impl Plugin for NetworkPlugin {
    fn build(&self, app: &mut App) {
        ...
        app
            ...
            .insert_resource(PlayerEntityLookup(SecondaryMap::new()))
...
pub fn recv_network_messages(
    ...
    mut lookup: ResMut<PlayerEntityLookup>,
