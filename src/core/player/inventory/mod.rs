...
use crate::core::network::protocol::play::clientbound::{SetSlot, WindowItems};
use crate::core::network::protocol::play::serverbound::{ClickMode, ClickWindow, ClientStatus, HeldItemChange};
use crate::core::network::protocol::play::serverbound;
use crate::core::player::inventory::item_stack::ItemStack;
use crate::core::player::inventory::menu::{Menu, MenuClick};
use crate::core::player::{PacketReader, PlayerPacketBuffer};
...
pub(crate) fn handle_click_window(
...
impl Plugin for InventoryPlugin  {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_observer(menu::on_close_menu)
