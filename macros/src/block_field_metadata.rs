...
pub fn block_field_metadata(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let mut match_arms: TokenStream = Default::default();
    ...
    quote! {
        impl BlockFieldMetadata for #ident {
